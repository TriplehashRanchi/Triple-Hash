    ...
    return (
        <div className={styles.layoutSection}>
            <div ref={textRef}>
                ...
                }} className={`animateLine text-transparent bg-clip-text ${styles.subTitle}`}>Empowering Communication
                    Service Providers</h1>
                <p className={`animateLine ${styles.sectionDescription}`}>We support all types of communication service providers (CSPs), from full-fledged
                    operations to branded resellers. Choose the deployment model that best suits your needs:</p>
            </div>
            ...
            <div className={styles.container}>
                ...
                >
                    <h2 className={activeSection === 'european-cloud' ? styles.sectionTitleActive : styles.sectionTitle}>European Cloud</h2>
                ...
                >
                    <h2 className={activeSection === 'on-premise' ? styles.sectionTitleActive : styles.sectionTitle}>On-Premise</h2>
                ...
                >
                    <h2 className={activeSection === 'hybrid' ? styles.sectionTitleActive : styles.sectionTitle}>Hybrid</h2>
