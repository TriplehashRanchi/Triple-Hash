            ...
            <div className="max-w-[1360px] mx-auto px-4 lg:px-8">
                ...
                >
                    <div className="lg:col-span-2">
                        ...
                        <motion.p variants={itemVariants} className="text-lg leading-relaxed text-[#C4BBD3] mb-8">
                            {project.description}
                        </motion.p>

                        {project.technologies && (
                            <>
                                <motion.h3 variants={itemVariants} className="text-2xl font-bold mb-3 text-white">
                                    Technologies Used
                                </motion.h3>
                        ...
                        {project.link && (
                            <motion.div variants={itemVariants} className="mt-8">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 bg-gradient-to-r from-[#FF8C00] to-[#FF0C00] text-white px-6 py-3 rounded-full font-semibold text-md transition-all duration-300 hover:scale-105"
                                >
                    ...
                    <div className="lg:col-span-1 border-l border-white/10 pl-8 space-y-8">
                        <motion.div variants={itemVariants}>
                            <h3 className="text-2xl font-bold mb-3 text-white">Client Details</h3>
                            <p className="text-xl font-semibold text-orange-400">{project.clientName}</p>
                            <p className="text-md text-gray-400">{project.profession}</p>
                        </motion.div>

                        <motion.div variants={itemVariants}>
                            <h3 className="text-2xl font-bold mb-3 text-white">Category</h3>
